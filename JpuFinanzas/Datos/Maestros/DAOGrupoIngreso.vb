...
Module DAOGrupoIngreso
    ...
    Public Function LeerGrupoIngresoDataset(ByVal estado As Integer) As DataSet
        Dim command As SqlCommand
    ...
    Public Function InsertarGrupoIngreso(ByVal objGrupoIngreso As GrupoIngreso, ByVal blnNuevo As Boolean) As Integer
        Dim command As SqlCommand

        Try
            connection.Open()
            command = New SqlCommand("Man_MaeGrupoIngreso", connection)
            command.CommandType = CommandType.StoredProcedure
    ...
    Public Function EliminarGrupoIngreso(ByVal objGrupoIngreso) As Integer
        ...
        Try
            connection.Open()
            command = New SqlCommand("Del_MaeGrupoIngreso", connection)
            command.CommandType = CommandType.StoredProcedure
