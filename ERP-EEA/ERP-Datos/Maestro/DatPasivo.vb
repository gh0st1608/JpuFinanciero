...
Public Class DatPasivo
    ...
    Public Function EliminarPasivo(ByVal objPasivo As EntPasivo) As Boolean
        Try
            connection.Open()
    ...
    Public Function LeerPasivo(ByVal IdPasivo As Integer, ByVal PeriodoId As Integer, ByVal GrupoId As Integer, TablaMaestra As Boolean) As DataTable
