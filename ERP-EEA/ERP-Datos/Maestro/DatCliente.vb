...
Public Class DatCliente
    ...
    Public Function ActualizarCliente(ByVal objCliente As EntCliente) As Boolean
        Try
            ...
            command.Parameters("@EstadoActivo").Value = objCliente.IdEstadoActivo
    ...
    Public Function LeerCliente(ByVal IdCliente As Integer, ByVal Descripcion As String, ByVal TablaMaestra As Boolean) As DataTable
        Dim resultadoDT As DataTable
        Dim resultadoDS As New DataSet
        Dim adapter As SqlDataAdapter
        Try
