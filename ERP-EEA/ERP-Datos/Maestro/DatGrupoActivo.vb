...
Public Class DatGrupoActivo
    ...
    Public Function EliminarGrupoActivo(ByVal objGrupoActivo As EntGrupoActivo) As Boolean
        Try
            connection.Open()
    ...
    Public Function LeerGrupoActivo(ByVal IdGrupoActivo As Integer, ByVal Descripcion As String, TablaMaestra As Boolean) As DataTable
