...
Public Class DatGrupoPatrimonio
    ...
    Public Function EliminarGrupoPatrimonio(ByVal objGrupoPatrimonio As EntGrupoPatrimonio) As Boolean
        Try
            connection.Open()
    ...
    Public Function LeerGrupoPatrimonio(ByVal IdGrupoPatrimonio As Integer, ByVal Descripcion As String, TablaMaestra As Boolean) As DataTable
