...
Public Class DatPatrimonio
    ...
    Public Function EliminarPatrimonio(ByVal objPatrimonio As EntPatrimonio) As Boolean
        Try
            connection.Open()
    ...
    Public Function LeerPatrimonio(ByVal IdPatrimonio As Integer, ByVal PeriodoId As Integer, ByVal GrupoId As Integer, TablaMaestra As Boolean) As DataTable
