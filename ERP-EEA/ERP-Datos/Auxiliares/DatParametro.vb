...
Public Class DatParametro
    ...
    Public Function LeerParametro(ByVal IdParametro As Integer, ByVal Descripcion As String, ByVal TipoParametro As String, ByVal TablaMaestra As Boolean) As DataTable
