...
#Region "Funciones Auxiliares"
    Private Sub CargarTablaPatrimonio()
        dataTable = negPatrimonio.ObtenerTabla(0, cbPeriodoFiltro.SelectedValue, 0, True)
...
#Region "Funciones Principales (CRUD)"
    ...
    Private Sub LeerPatrimonio()
        If dgvPatrimonio.Rows.Count > 0 Then
            entPatrimonio = negPatrimonio.ObtenerData(dgvPatrimonio.CurrentRow.Cells("IdPatrimonio").Value, 0, 0)
