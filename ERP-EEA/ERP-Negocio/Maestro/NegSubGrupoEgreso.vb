...
Public Class NegSubGrupoEgreso
    ...
    Public Function ObtenerTabla(TablaMaestra As Boolean) As DataTable
        Return ObjSubGrupoEgresoDat.LeerSubGrupoEgreso(0, 0, TablaMaestra)
    End Function

    Public Function ObtenerData(ByVal Id As Integer) As EntSubGrupoEgreso
        Dim Dt As DataTable
        Dt = ObjSubGrupoEgresoDat.LeerSubGrupoEgreso(Id, 0, True)
    ...
    Public Function ObtenerLista(ByVal Filtro As Boolean, ByVal Seleccion As Boolean, ByVal GrupoEgresoId As Integer) As List(Of EntSubGrupoEgreso)
        ...
        Dim Dt As DataTable
        Dt = ObjSubGrupoEgresoDat.LeerSubGrupoEgreso(0, GrupoEgresoId, False)
        If (Dt.Rows.Count() > 0) Then
            If (Filtro) Then
