...
Public Class NegContacto
    ...
    Public Function ObtenerTabla(ByVal TipoContactoId As Integer, ByVal OrigenId As Integer, TablaMaestra As Boolean) As DataTable
        Return ObjContactoDat.LeerContacto(0, TipoContactoId, OrigenId, TablaMaestra)
    End Function

    Public Function ObtenerData(ByVal Id As Integer, ByVal TipoContactoId As Integer, ByVal OrigenId As Integer) As EntContacto
        Dim Dt As DataTable
        Dt = ObjContactoDat.LeerContacto(Id, TipoContactoId, OrigenId, True)
