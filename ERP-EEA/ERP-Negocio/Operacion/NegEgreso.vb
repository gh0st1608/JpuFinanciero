...
Public Class NegEgreso
    ...
    Public Function ObtenerTabla(ByVal IdEgreso As Integer, ByVal PeriodoId As Integer, ByVal ProveedorId As Integer, ByVal Alerta As Boolean) As DataTable
        Return ObjEgresoDat.LeerEgreso(IdEgreso, PeriodoId, ProveedorId, Alerta)
    End Function

    Public Function ObtenerData(ByVal Id As Integer, ByVal PeriodoId As Integer) As EntEgreso
        Dim Dt As DataTable
        Dt = ObjEgresoDat.LeerEgreso(Id, PeriodoId, 0, False)
